<template>
  ...
  <div class="container mt-5">
    <div class="card shadow-sm my-6">
      <div class="card-header bg-white d-flex">
        <h4 class="card-title">กรองสถิติเชิงพื้นที่</h4>
      </div>
      <div class="card-body">
    ...
    <div class="row">
      <h4 class="mt-6">สถิติเชิงพื้นที่</h4>
      ...
      <div class="col-12 col-md-6 mb-3 mt-2">
        <div class="card">
          <div class="card-body overflow-scroll">Chart Amphur</div>
        </div>
      </div>
  ...
  <!-- Modal Detail -->
  <div class="modal fade" tabindex="-1" ref="detailModalRef" id="detail-model">
    <div class="modal-dialog modal-xl">
      <div class="modal-content">
        <div class="modal-header">
          <h3 class="modal-title">สรุปข้อมูล</h3>
        ...
        <div class="modal-body">
          <div class="row">
            ...
            <div class="col-md-12 mb-10">
              เรื่องร้องเรียนทั้งหมด 400 เรื่อง เสร็จสิ้น 200 เรื่อง
              อยู่ระหว่างดำเนินการ 200 เรื่อง
            </div>

            <div class="col-md-6">
              <h5>สรุปประเภทของเรื่องร้องเรียน</h5>
              <table class="table table-bordered">
                ...
                <tbody>
                  <tr>
                    <td class="text-center">ประเภท 1</td>
                    <td class="text-center">5</td>
                  </tr>
                  <tr>
                    <td class="text-center">ประเภท 2</td>
            ...
            <div class="col-md-6">
              <h5>สรุปหน่วยงานที่ถูกเรื่องร้องเรียน</h5>
              <table class="table table-bordered">
                <thead>
                  <tr>
                ...
                <tbody>
                  <tr>
                    <td class="text-center">หน่วยงาน 1</td>
                    <td class="text-center">5</td>
                  </tr>
                  <tr>
                    <td class="text-center">หน่วยงาน 2</td>
                    <td class="text-center">10</td>
                  </tr>
                </tbody>
              </table>
            ...
            <div class="col-md-6">
              <h5>สรุปเจ้าหน้าที่ถูกเรื่องร้องเรียน</h5>
              <table class="table table-bordered">
                <thead>
                  <tr>
            ...
            <div class="col-md-6">
              <h5>สรุปหน่วยงานที่มีการแจ้งเบาะแส</h5>
              <table class="table table-bordered">
                <thead>
                  <tr>
                    <th class="text-center">หน่วยงาน</th>
            ...
            <div class="col-md-6">
              <h5>สรุปเรื่องร้องเรียนเกี่ยวกับสารเสพติด</h5>
              <table class="table table-bordered">
                <thead>
                  <tr>
                    <th class="text-center">ชื่อเจ้าหน้าที่</th>
...
import am5geodata_THLow from "@amcharts/amcharts5/geodata/thailandLow";
import am5geodata_THDistricts from "@amcharts/amcharts5/geodata/districts.json";
...
export default defineComponent({
  ...
  setup() {
    ...
    const chartOrganizationOptions = {
      plugins: {
        legend: {
          display: true,
          position: "right",
    ...
    // Chart
    const gChartType = "GeoChart";
    const gChartData = [
      ["จังหวัด", "จำนวนเรื่องร้องเรียน", "เสร็จสิ้น"],
      ["Bangkok", 1000, 500],
      ["Chiang Mai", 900, 400],
      ["Chiang Rai", 200, 300],
      ["Trang", 200, 100],
      ...
      ["Lampang", 900, 300],
      ["Lamphun", 100, 300],
      ["Mae Hong Son", 200, 300],
      ["Nan", 400, 300],
      ["Phayao", 1000, 300],
      ["Phrae", 100, 300],
      ["Uttaradit", 300, 300],
      ["Sakon Nakhon", 300, 300],
      ["Nong Khai", 300, 300],
      ["TH-38", 100, 300],
      ["TH-31", 300, 400],
      ["TH-37", 300, 400],
    ...
    const gChartOptions = {
      ...
      region: "TH",
      // province: "Bangkok",
      resolution: "provinces", //provinces
      colorAxis: { colors: ["#00853f", "white", "#e31b23"] },
      backgroundColor: "#fff",
      datalessRegionColor: "#c4d1e6",
      defaultColor: "#fff",
      // defaultColor: "#000",
    };
    ...
    onMounted(() => {
      ...
      let thMaps = am5geodata_data_countries2["TH"];
