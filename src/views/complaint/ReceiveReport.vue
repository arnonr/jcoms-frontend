<template>
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="mb-7 col-12 col-lg-6">
        <label for="surname" class="required form-label">เหตุผล</label>
        <v-select
          label="name"
          name="id"
          placeholder="ห้วงเวลาเกิดเหตุ"
