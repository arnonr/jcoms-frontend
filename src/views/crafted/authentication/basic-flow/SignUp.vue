  ...
  <div class="w-lg-500px p-10">
    ...
    >
      ...
      <div class="mb-10 text-center">
        <!--begin::Title-->
        <h1 class="text-gray-900 mb-3">สมัครใช้งาน</h1>
        <!--end::Title-->
      ...
      <div class="row fv-row mb-7">
        <!--begin::Col-->
        <div class="col-xl-6">
          <label class="form-label fw-bold text-gray-900 fs-6">ชื่อ</label>
          <Field
        ...
        <!--begin::Col-->
        <div class="col-xl-6">
          <label class="form-label fw-bold text-gray-900 fs-6">นามสกุล</label>
          <Field
            class="form-control form-control-lg form-control-solid"
            type="text"
            placeholder=""
      ...
      <div class="mb-10 fv-row" data-kt-password-meter="true">
        ...
        <div class="mb-1">
          <!--begin::Label-->
          <label class="form-label fw-bold text-gray-900 fs-6"> รหัสผ่าน </label>
          <!--end::Label-->
