        ...
        <div class="row">
          ...
          <div class="accordion" id="myAccordion">
            ...
            <div class="accordion-item">
              <h2 class="accordion-header">
                ...
                >
                  <h4 class="color-primary">รายละเอียดการดำเนินการ</h4>
                </button>
              </h2>
              <div
                id="item2"
          ...
          <div class="section-history">
            ...
            <div class="col-md-12 mb-2">
              ...
              >
                <span class="me-2 fw-bold">รายละเอียดการดำเนินการ : </span>
                <span class="badge p-2 text-white fw-bold bg-success">คลิก</span>
              </button>
              <div class="accordion col-md-12" id="accordionExample1">
                <div class="accordion-item">
                  <div
                    id="collapseDetail"
                    class="accordion-collapse collapse"
                      ...
                      <table class="table table-bordered">
                        ...
                        <tr v-if="complaint_forward_state.state11 != null">
                          ...
                          <td class="fw-bold p-3">
                            {{ complaint_forward_state.state11.state.name_th }}
                            ({{
                              complaint_forward_state.state11.to_division
                                ?.name_th
                            }})
                          </td>
                          <td class="p-3">
